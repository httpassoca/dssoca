  ...
  props: [
    {
      name: 'lines',
      type: 'LogLine[]',
      desc: 'Controlled lines. When provided, renders exactly these (capped to `maxLines`); demo off.',
    },
    {
      name: 'initialLines',
      type: "Omit<LogLine, 'id'>[]",
      desc: 'Seed lines for the built-in demo stream (used when `lines` is undefined).',
    },
    {
      name: 'demo',
      type: 'boolean',
      desc: 'Generate a random demo stream. Defaults true ONLY when `lines` is not supplied.',
    },
    { name: 'live', type: 'boolean', desc: 'Back-compat alias for `demo`.' },
    {
      ...
      type: 'number',
      default: '30',
      desc: 'Max lines kept in the buffer (oldest dropped).',
    },
    {
      name: 'controls',
      type: 'boolean',
      default: 'true',
      desc: 'Show the controls toolbar (filters, search, wrap, copy, clear).',
    },
    { name: 'toolbar', type: 'Snippet', desc: 'Replace the built-in toolbar entirely.' },
    {
      ...
      type: 'boolean',
      default: 'true',
      desc: 'Wrap long messages (pre-wrap) vs. horizontal scroll (pre).',
    },
    {
      name: 'announce',
      type: "'off' | 'polite' | 'assertive'",
      default: "'polite'",
      desc: 'aria-live politeness for the log region.',
    },
    {
      name: 'ariaLabel',
      type: 'string',
      default: "'Log output'",
      desc: 'Accessible label for the log region.',
    },
    {
      name: 'loading',
      type: 'boolean',
      default: 'false',
      desc: 'Show a connecting/loading indicator.',
    },
