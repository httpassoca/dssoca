...
/>`,
  props: [
    ...
    {
      name: 'status',
      type: "'up' | 'deg' | 'down' | 'maint'",
      default: "'up'",
      desc: 'Status tone (also folded into the accessible name).',
    },
    ...
    { name: 'spark', type: 'number[]', desc: 'Sparkline series (has a built-in default).' },
    {
      name: 'href',
      type: 'string',
      desc: 'When set, the card renders as a real <a> and navigates here.',
    },
    {
      name: 'onclick',
      type: '() => void',
      desc: 'Click handler (for the non-link interactive card).',
    },
    {
      name: 'loading',
      type: 'boolean',
      default: 'false',
      desc: 'Render skeleton placeholders and mark aria-busy; suppresses interaction.',
    },
    {
      name: 'disabled',
      type: 'boolean',
      default: 'false',
      desc: 'Non-interactive variant: aria-disabled, no focus/pointer, no onclick.',
    },
    {
      name: 'updatedAt',
      type: 'Date | string',
      desc: '"Last checked" instant; rendered as relative time in a <time datetime> footer.',
    },
    {
      name: 'meta',
      type: 'Snippet',
      desc: 'Optional extra metadata rows (version, IP, tags…) below the head.',
    },
    SIZE_PROP,
  ],
}
