...
/>`,
  props: [
    ...
    },
    {
      name: 'xDomain',
      type: '[number, number]',
      desc: 'Force the x domain; defaults to the padded data extent.',
    },
    {
      name: 'yDomain',
      type: '[number, number]',
      desc: 'Force the y domain; defaults to the padded data extent.',
    },
    {
      name: 'xFormat',
      type: '(x: number) => string',
      desc: 'Format an x value for ticks + tooltip.',
    },
    {
      name: 'yFormat',
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'true',
      desc: "Draw each point's label next to its dot.",
    },
