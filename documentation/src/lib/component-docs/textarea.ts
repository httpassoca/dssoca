...
/>`,
  props: [
    ...
    { name: 'rows', type: 'number', default: '3', desc: 'Visible rows; the minimum height (also while autosizing).' },
    { name: 'autosize', type: 'boolean', default: 'false', desc: 'Grow with content (`field-sizing: content`, JS fallback); disables manual resize.' },
    { name: 'maxRows', type: 'number', default: '10', desc: 'Row cap while autosizing — the field scrolls beyond it.' },
    ...
    { name: 'hint', type: 'string', desc: 'Helper text rendered under the textarea and wired via aria-describedby.' },
    { name: 'error', type: 'string', desc: 'Error text under the textarea; implies aria-invalid and is announced to AT.' },
    ...
    SIZE_PROP,
    { name: '...rest', type: 'HTMLTextareaAttributes', desc: 'Any remaining native textarea attributes / handlers are forwarded.' },
  ],
  notes:
