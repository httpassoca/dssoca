...
<Sparkline data={[12, 9, 11, 6, 4]} trend="auto" variant="area" fluid />`,
  props: [
    ...
    },
    {
      ...
      desc: 'Bar/line fill. Ignored when `trend` resolves to a direction.',
    },
    {
      name: 'trend',
      type: "'auto' | 'up' | 'down' | 'flat' | 'none'",
      default: "'none'",
      desc: 'Colour by direction; `auto` derives first-vs-last → success/danger/muted.',
    },
    {
      name: 'min',
      type: 'number',
      desc: 'Lower scale bound. Defaults to the data min — set to fix the scale across rows.',
    },
    {
      name: 'max',
      type: 'number',
      desc: 'Upper scale bound. Defaults to the data max — set to fix the scale across rows.',
    },
    {
      name: 'fluid',
      type: 'boolean',
      default: 'false',
      desc: 'Flex the chart to fill its container width (table-cell friendly).',
    },
    {
      name: 'width',
      type: 'string',
      desc: "Explicit CSS width (e.g. '120px', '100%'); overrides the intrinsic width.",
    },
    {
      name: 'label',
      type: 'string',
      desc: 'Accessible name; overrides the auto-generated summary (sets role="img").',
    },
    {
      name: 'summary',
      type: 'string',
      desc: 'Replace the auto-generated screen-reader summary entirely.',
    },
    {
      name: 'valueFormat',
      type: '(v: number) => string',
      desc: 'Format a value for the screen-reader summary (e.g. v => v + "%").',
    },
    SIZE_PROP,
  ],
}
