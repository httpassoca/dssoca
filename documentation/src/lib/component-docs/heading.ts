...
<Heading centered>centered title</Heading>`,
  props: [
    { name: 'level', type: '1 | 2 | 3 | 4 | 5 | 6', default: '1', desc: 'Heading level — picks the rendered element (h1…h6); styling is level-independent.' },
    { name: 'accent', type: 'boolean', default: 'true', desc: 'Primary accent underline behind the text.' },
