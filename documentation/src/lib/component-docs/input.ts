...
/>`,
  props: [
    ...
    },
    {
      name: 'hint',
      type: 'string',
      desc: 'Helper text rendered under the input and wired via aria-describedby.',
    },
    {
      name: 'error',
      type: 'string',
      desc: 'Error text under the input; implies aria-invalid and is announced to AT.',
    },
    {
      name: 'describedby',
      type: 'string',
    ...
    },
    {
      name: 'prefix',
      type: 'Snippet',
      desc: 'Decorative leading content inside the field, before the input.',
    },
    {
      name: 'suffix',
      type: 'Snippet',
      desc: 'Decorative trailing content inside the field, after the input.',
    },
    {
      name: 'clearable',
      type: 'boolean',
      default: 'false',
      desc: 'Renders a clear button; hidden when empty/readonly/disabled.',
    },
    { name: 'autocomplete', type: 'FullAutoFill', desc: 'Native autocomplete hint.' },
    {
      name: 'inputmode',
      type: "HTMLInputAttributes['inputmode']",
      desc: 'Native inputmode hint for on-screen keyboards.',
    },
    ...
    SIZE_PROP,
    {
      ...
      desc: 'Any remaining native input attributes / handlers are forwarded.',
    },
  ],
}
