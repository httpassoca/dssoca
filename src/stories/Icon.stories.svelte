...
{#snippet template(args: Record<string, unknown>)}
  <Icon name={args.name as IconName} size={args.size as number} />
{/snippet}
  ...
  <div style="display:flex;flex-wrap:wrap;gap:1.5rem;align-items:flex-start;">
    {#each ALL_NAMES as iconName}
      <div style="display:flex;flex-direction:column;align-items:center;gap:0.375rem;width:5rem;">
        <Icon name={iconName} size={args.size as number} />
...
<Story name="Default" args={{ name: 'grid', size: 24 }} />

<Story name="Activity" args={{ name: 'activity', size: 24 }} />

<Story name="Settings" args={{ name: 'settings', size: 24 }} />

<Story name="Terminal" args={{ name: 'terminal', size: 24 }} />

<Story name="Large" args={{ name: 'target', size: 48 }} />

<Story name="Small" args={{ name: 'check', size: 12 }} />

<Story name="Gallery" render={gallery} args={{ size: 32 }} />
